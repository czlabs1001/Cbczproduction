	...
	class sw_woo_slider_countdown_widget extends WP_Widget { 
				...
				array(
				 ...
				 array(
				  ...
				  array(
					...
					"param_name" => "layout",
					"admin_label" => true,
					"value" => array( 'Layout Default' => 'default', 'Layout Countdown 2' => 'layout2', 'Layout Countdown 3' => 'layout3', 'Layout Countdown 4' => 'layout4', 'Layout Countdown 5' => 'layout5', 'Layout Countdown 6' => 'layout6', 'Layout Countdown 7' => 'layout7', 'Layout Countdown Mobile' => 'layout1', 'Layout Countdown Mobile2' => 'countdown-mobile' ),
		...
		**/
		function WS_Shortcode_Countdown( $atts, $content = null ){
			...
			if( $layout == 'default' ){
			...
			}elseif( $layout == 'countdown-mobile' ){
				...
				include( sw_override_check( 'sw-countdown-slider', 'countdown7' ) );			
		...
		*/		
		...
		?>
			<div class="tab-pane active" id="<?php echo esc_attr( $target ) ?>">
				...
				<div id="<?php echo esc_attr( 'tab_countdown_'. $target ); ?>" class="woo-tab-container-slider responsive-slider loading clearfix" data-dots="true" data-lg="<?php echo esc_attr( $columns ); ?>" data-md="<?php echo esc_attr( $columns1 ); ?>" data-sm="<?php echo esc_attr( $columns2 ); ?>" data-xs="<?php echo esc_attr( $columns3 ); ?>" data-mobile="<?php echo esc_attr( $columns4 ); ?>" data-speed="<?php echo esc_attr( $speed ); ?>" data-scroll="<?php echo esc_attr( $scroll ); ?>" data-interval="<?php echo esc_attr( $interval ); ?>"  data-autoplay="<?php echo esc_attr( $autoplay ); ?>">
											...
											<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
												<?php 
													...
													if ( has_post_thumbnail() ){
															echo get_the_post_thumbnail( $post->ID, 'shop_thubnail' ) ? get_the_post_thumbnail( $post->ID, 'shop_thubnail' ): '<img src="'.get_template_directory_uri().'/assets/img/placeholder/'.'large'.'.png" alt="No thumb">';		
													}else{
		...
		public function form( $instance ) {
			...
			<p>
				...
				<select class="widefat"
					...
					<?php } ?>>
						<?php _e('Layout Tab Countdownt', 'sw_woocommerce')?>
					</option>
					<option value="countdown-mobile" <?php if ($widget_template=='countdown-mobile'){?> selected="selected"
					<?php } ?>>
						<?php _e('Countdown Mobile', 'sw_woocommerce')?>
					</option>
				</select>
			</p>  
		<?php
