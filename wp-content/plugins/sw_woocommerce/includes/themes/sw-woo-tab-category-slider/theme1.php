...
?>
<div class="sw-woo-tab-cat2 sw-ajax clearfix" id="<?php echo esc_attr( 'category_' . $widget_id ); ?>" >
	<div class="resp-tab" style="position:relative;">
		<div class="banner-inner clearfix">
			<?php if( $img_banners != '' ) : ?>
			<?php $img = wp_get_attachment_image( $img_banners, 'full' ); ?>
			<div class="item-banner"><a href="<?php echo esc_url( $banner_links ); ?>"><?php echo $img ?></a></div>
