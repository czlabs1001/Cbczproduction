...
class WC_LD_Settings_Tab {
	...
	public static function get_settings() {
		$settings = array(
			...
			array(
				'title' => __( 'Show Product License Description', 'highthemes' ),
				'desc'    => __( 'Show product license delivery description on the thank you page.', 'highthemes' ),
				'id'    => self::SETTINGS_NAMESPACE . '_description_thank_you',
				'default' => 'no',
				'type'    => 'checkbox',
