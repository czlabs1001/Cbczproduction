...
class WC_LD_Admin_Scripts {
	...
	public function enqueue_scripts() {
		...
		$pages = array( 'license_code_edit', 'license_codes', 'license_code_csv_upload', 'csv_export' );
		...
		if ( ($pagenow == 'admin.php' && in_array( $_GET['page'], $pages )) || (($pagenow=='post.php' || $pagenow=='post-new.php') && $post->post_type=='product')) {
			...
			wp_enqueue_script( 'postbox' );
			 wp_enqueue_media();
			wp_enqueue_script( 'license-delivery-admin-js', plugins_url( '/assets/js/wc-ld-admin.js', WooCommerce_License_Delivery::get_plugin_file() ), array( 'jquery','wc-ld-select2','media-upload'), false, false );
