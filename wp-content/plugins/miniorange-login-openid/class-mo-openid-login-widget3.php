        ...
        if($theme=="default")
        {
            ...
            foreach($a as $app){
                ...
                if($app_name=="google")
                {
                    ...
                    if ($selected_theme == 'longbutton') {
                        $html .= "<a rel='nofollow' " . $gdpr_setting . " style='margin-left: " . $spacebetweenicons . "px !important;width: 100% !important; padding-top:" . ($customHeight - 29) . "px !important;padding-bottom:" . ($customHeight - 29) . "px !important;margin-bottom: " . ($spacebetweenicons - 5) . "px !important;border-radius: " . $customBoundary . "px !important;'";
                        if ($view == "horizontal") {
                ...
                foreach($a as $app){
                    ...
                    if ($selected_theme == 'longbutton') {
                        $html .= "<a rel='nofollow' " . $gdpr_setting . " style='border-color:#000000; margin-left: " . $spacebetweenicons . "px !important;width: 100% !important; padding-top:" . ($customHeight - 29) . "px !important;padding-bottom:" . ($customHeight - 29) . "px !important;margin-bottom: " . ($spacebetweenicons - 5) . "px !important;border-radius: " . $customBoundary . "px !important;'";
                        if ($view == "horizontal") {
