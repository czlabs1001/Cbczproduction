	...
	class sw_resp_slider extends WP_Widget {
		...
		*/
		function resp_slider_script(){	
			wp_register_script( 'slick-slider', SWURL . '/js/slick.min.js', array(), null, true );		
			if (!wp_script_is('slick-slider')) {
				wp_enqueue_script('slick-slider');
			}
			if (!wp_script_is('slick-slider-init')) {
				wp_enqueue_script('slick-slider-init', SWURL . '/js/slickslider-init.js', array(), null, true );	
			}
			if( defined( 'ELEMENTOR_VERSION' ) ) :
				wp_enqueue_script( 'sw-slider-editor', SWURL . '/js/editor.js', array(), null, true );
			endif;
		}
			...
			vc_map( array(
				...
				'class'         => ''
				 ...
				 array(
					...
					"param_name" => "layout",
					"value" => array( 'Layout Default' => '1', 'Layout Theme 1' => '2', 'Layout Theme 2' => '3', 'Layout Theme 3' => '4', 'Layout Theme 4' => '5', 'Layout Theme 5' => '6', 'Layout Theme 6' => '7', 'Layout Theme Mobile' => 'theme-mobile' ),
		...
		**/
		function RP_Shortcode( $atts, $content = null ){
			...
			ob_start();		
			if( $layout == 1 ){
				include( sw_core_override_check( 'sw-responsive-post', 'default') );
			}elseif( $layout == 2 ){
				include( sw_core_override_check( 'sw-responsive-post', 'theme1') );
			}elseif( $layout == 3 ){
				include( sw_core_override_check( 'sw-responsive-post', 'theme2') );
			}elseif( $layout == 4 ){
				include( sw_core_override_check( 'sw-responsive-post', 'theme3') );
			}elseif( $layout == 5 ){
				include( sw_core_override_check( 'sw-responsive-post', 'theme4') );
			}elseif( $layout == 6 ){
				include( sw_core_override_check( 'sw-responsive-post', 'theme5') );
			}elseif( $layout == 7 ){
				include( sw_core_override_check( 'sw-responsive-post', 'theme6') );
			}elseif( $layout == 'theme-mobile' ){
				include( sw_core_override_check( 'sw-responsive-post', 'theme-mobile') );
			}
		...
		public function widget( $args, $instance ) {
			...
			if ( $tpl = sw_core_override_check( 'sw-responsive-post', $instance['widget_template'] ) ){ 
