...
class sw_testimonial_slider_widget extends WP_Widget {
				...
				array(
			 	...
			 	array(
					...
					'value' => array(
						...
						__( 'Layout Theme 1','sw_core' ) => 'layout1',
						__( 'Layout Theme 2','sw_core' ) => 'layout2',
						__( 'Layout Theme 3','sw_core' ) => 'layout3',
					),
	...
	**/
	function TT_Shortcode( $atts,$content = null ){
		...
		ob_start();		
		if( $layout == 'default' ){
			include( sw_core_override_check( 'sw-testimonial', 'default' ) );
		}elseif( $layout == 'layout1' ){
			include( sw_core_override_check( 'sw-testimonial', 'layout1') );
		}elseif( $layout == 'layout2' ){
			include( sw_core_override_check( 'sw-testimonial', 'layout2') );
		}elseif( $layout == 'layout3' ){
			include( sw_core_override_check( 'sw-testimonial', 'layout3') );
		}
	...
	public function widget( $args, $instance ) {
		...
		if ( $tpl = sw_core_override_check( 'sw-testimonial', $instance['widget_template'] ) ){ 
